import{c as t,r as i,m as a}from"./instance.AS_mdBWu.js";import{u as r}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=`<h2>Våra Gårdar: Interactive Map for Venues and Activities</h2>
<h3>Introduction:</h3>
<p>
...
`}function y(){return n}function w(){return[]}const b=t((d,c,p)=>{const{layout:u,...e}=o;return e.file=s,e.url=l,i`${a()}${r(n)}`});export{b as Content,y as compiledContent,b as default,s as file,o as frontmatter,w as getHeadings,f as rawContent,l as url};
