import{c as a,r as o,m as t}from"./instance.AS_mdBWu.js";import{u as i}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=` <h2>Mekonomen Car Repair Website: A Case Study in Agile Development and Multi-site Implementation</h2>
  <h3>Introduction:</h3>
  <p>
  ...
  </p>`,s={onHome:!0,title:"Mekonomen",title2:"International",description:"Multi-site WordPress website for Mekonomen, featuring Google Maps integration, shop landing pages, and a booking system with API-based service cost calculation.",date:"2016",status:"publish",permalink:"mekonomen",author:"Ehsan",agency:"whitespace",type:"portfolio",id:103,category:["Backend","Front-end"],tag:["CSS","Google Maps Api","HTML","Javascript","Maintenance","SOAP","Support","Wordpress"],body_text:[""],client:"Mekonomen",tagline:"Car spare parts, car components & car services online",background_image:"bg.jpg",logo:"mekonomen-1.png",cover:"mekonomen.jpg",video:"",images:["4.png","mekonomen-2.jpg","mekonomen-3.jpg"],case_link_url:"https://www.mekonomen.fi/"},r="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/mekonomen/mekonomen.md",l=void 0;function b(){return`
...
`}function v(){return n}function k(){return[]}const w=a((d,c,p)=>{const{layout:m,...e}=s;return e.file=r,e.url=l,o`${t()}${i(n)}`});export{w as Content,v as compiledContent,w as default,r as file,s as frontmatter,k as getHeadings,b as rawContent,l as url};
