import{c as n,r as o,m as a}from"./instance.AS_mdBWu.js";import{u as s}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const t=`<h2>Soctanter på nätet: A Case Study in Developing a User-Friendly Platform for Social Guidance</h2>
  <h3>Introduction:</h3>
  <p>
  ...
  </p>`,r={title:"Soctanter",date:"2019-03-28T12:03:32+00:00",status:"publish",permalink:"soctanter",author:"Ehsan",excerpt:"",type:"portfolio",id:249,agency:"Whitespace",category:["Backend","Front-end","UX"],tag:["Drupal","PHP","Support","UX","Web Development"],case_link_url:"https://soctanter.malmo.se",body_text:[""],client:"Malmöstad",tagline:"Malmö stads socialrådgivning på nätet vägleder dig i dina bekymmer.",background_image:"bg.png",logo:"logo.png",images:["1.png","2.png"],port_date:["2016"]},i="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/soctanter.md",d=void 0;function w(){return`
...
`}function y(){return t}function v(){return[]}const b=n((l,u,c)=>{const{layout:p,...e}=r;return e.file=i,e.url=d,o`${a()}${s(t)}`});export{b as Content,y as compiledContent,b as default,i as file,r as frontmatter,v as getHeadings,w as rawContent,d as url};
