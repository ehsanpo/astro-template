import{c as i,r as n,m as a}from"./instance.AS_mdBWu.js";import{u as s}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const t=`<h3>Roofit Campaign Website: A Case Study in Promoting Lindab's Administration Services for Roofers and Tinsmith Workers</h3>
  <h3>Introduction:</h3>
  <p>
  ...
  </p>`,o={title:"RooFit",date:"2019-03-28T12:54:27+00:00",status:"publish",permalink:"roofit",author:"Ehsan",type:"portfolio",id:316,agency:"Guts & Glory",category:["Backend","Front-end"],tag:["Wordpress","HTML","Javascript","PHP"],case_link_url:"https://roofit.se/",client:"Lindab",tagline:"En plåtslagare ska knacka plåt",background_image:"roofit-garanti-image.jpg",logo:"logo.png",video:"https://www.youtube.com/watch?v=JrqKl-BfedI",images:["12.jpg","3.jpg"],port_date:["2018"]},r="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/roofit.md",d=void 0;function b(){return`
...
`}function w(){return t}function v(){return[]}const y=i((l,m,h)=>{const{layout:c,...e}=o;return e.file=r,e.url=d,n`${a()}${s(t)}`});export{y as Content,w as compiledContent,y as default,r as file,o as frontmatter,v as getHeadings,b as rawContent,d as url};
