import{c as t,r as n,m as a}from"./instance.AS_mdBWu.js";import{u as i}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const o=`<h2>ToolPool - Verktygsutlåning: A Case Study in Innovative Tool Sharing</h2>
  <h3>Introduction:</h3>
  <p>
...
<p>ToolPool has been awarded in Cannes Lions (Silver Lion in Promo &#x26; Activation, Bronze Lion in Cyber and Shortlist in Media), Guldägget (Golden Egg in PR, Silver Egg in Digital and Silver Egg in Alternative Media), Tomorrow Awards (Shortlist), Spinn (Shortlist x3), Best Ads (Gold), Campaign of the Month, Interactive (Gold), 100-wattaren (Gold) and published in Contagius Magazine.</p>
 <p></p>`,s={onHome:!0,title:"ToolPool",title2:"Handyman Store",description:"Developed the award-winning ToolPool platform, enabling free tool lending via Facebook and a dedicated website to boost Malmö Hardware Store's sales by 25%.",date:"2012",status:"publish",permalink:"toolpool",author:"Ehsan",type:"portfolio",id:1337,agency:"The Fan Club",category:["Backend","Front-end","UX"],tag:["CSS","HTML","Javascript","PHP"],background_image:"toolpool-top1.jpg",logo:"toolpool-4.jpg",cover:"toolpool.jpg",video:"https://www.youtube.com/watch?v=V8zOcBKLfko",images:["toolpool-top.jpg","toolpool-1.jpg","toolpool-3.jpg","site-1.jpg"],tagline:"ToolPool is like a carpool, but with tools and it’s free.",case_link_url:"https://www.malmojarnhandel.se/ToolPool-Verktygsutl%C3%A5ning",client:"Malmö Järnhandel"},r="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/toolpool/toolpool.md",l=void 0;function v(){return`
...
`}function w(){return o}function b(){return[]}const y=t((d,c,h)=>{const{layout:p,...e}=s;return e.file=r,e.url=l,n`${a()}${i(o)}`});export{y as Content,w as compiledContent,y as default,r as file,s as frontmatter,b as getHeadings,v as rawContent,l as url};
