const e="building-family-tracking-app-expo-supabase/index.md",n="blog",t="building-family-tracking-app-expo-supabase",a=`
...
`,o={title:"Building a Family Tracking App: Privacy-First Location Sharing with Expo & Supabase",description:"My wife asked me to find a tracking app so we can track the kids on their way home from school. Turns out they're all privacy nightmares, so I decided to build my own instead! Here's the chaotic journey of building a family location tracker with React Native, Expo, and Supabase.",date:"2025-12-25",author:"Ehsan Pourhadi",category:["Mobile Development","Real-time Apps"],tag:["React Native","Expo","Supabase","Location Tracking","Privacy","TypeScript","Real-time"],featured:!0,draft:!1},i={type:"content",filePath:"C:/Users/Ehsan/dev/astro-template/src/content/blog/building-family-tracking-app-expo-supabase/index.md",rawData:void 0};export{i as _internal,a as body,n as collection,o as data,e as id,t as slug};
