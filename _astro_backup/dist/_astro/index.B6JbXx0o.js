const o="why-agile-ai-coding-feels-kinda-broken/index.md",a="blog",i="why-agile-ai-coding-feels-kinda-broken",s=`
So I’ve been thinking about this a lot lately (probably too much lol). Everyone in dev land keeps saying: _“We work Agile. We do sprints. We build MVPs first. Nice-to-haves later.”_
...
1. **Can AI generate me an overall plan?**
2. **Can it break that plan into pieces?**
3. **Which parts do I actually care about, and which can I let the AI cook?**
...
`,r={title:"🤖 Why Agile + AI Coding Feels Kinda Broken",description:"How AI changes the Agile workflow when solo-building, speedruns, and new practices.",date:"2025-12-08",author:"Ehsan",category:["Agile","AI"],tag:["agile","ai","workflow","productivity"],cover:new Proxy({src:"/_astro/cover-agile-dev-ai.BfQh9X6t.png",width:2816,height:1536,format:"png",fsPath:"C:/Users/Ehsan/dev/astro-template/src/content/blog/why-agile-ai-coding-feels-kinda-broken/cover-agile-dev-ai.png"},{get(t,e,n){return e==="clone"?structuredClone(t):e==="fsPath"?"C:/Users/Ehsan/dev/astro-template/src/content/blog/why-agile-ai-coding-feels-kinda-broken/cover-agile-dev-ai.png":(t[e]!==void 0&&globalThis.astroAsset&&globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/blog/why-agile-ai-coding-feels-kinda-broken/cover-agile-dev-ai.png"),t[e])}}),featured:!1,draft:!1},l={type:"content",filePath:"C:/Users/Ehsan/dev/astro-template/src/content/blog/why-agile-ai-coding-feels-kinda-broken/index.md",rawData:void 0};export{l as _internal,s as body,a as collection,r as data,o as id,i as slug};
