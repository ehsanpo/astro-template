import{c as t,r as o,m as a}from"./instance.AS_mdBWu.js";import{u as i}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=`<h2>Holy Green Salad Bar Website: A Case Study in Rebranding and Website Development</h2>
  <h3>Introduction:</h3>
  <p>
...
`,r={title:"Holy Greens",date:"2019-03-28T12:51:30+00:00",status:"publish",permalink:"holy-greens",author:"Ehsan",type:"portfolio",id:320,agency:"Guts & Glory",category:["Backend","Front-end"],tag:["CSS","HTML","Javascript","PHP","UX","Web Development","Wordpress"],case_link_url:"https://www.holygreens.se/",body_text:[""],client:"Holy Greens",tagline:"Eating fast, good and healthy should be straightforward.",background_image:"44.jpg",logo:"hg.png",video:"",images:["hoolygreens -fsc.jpg"],port_date:["2018"]},s="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/holy-greens/holy-greens.md",l=void 0;function w(){return`
...
`}function y(){return n}function v(){return[]}const f=t((d,h,p)=>{const{layout:c,...e}=r;return e.file=s,e.url=l,o`${a()}${i(n)}`});export{f as Content,y as compiledContent,f as default,s as file,r as frontmatter,v as getHeadings,w as rawContent,l as url};
