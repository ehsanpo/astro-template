import{c as t,r as i,m as a}from"./instance.AS_mdBWu.js";import{u as r}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=`<h2>Background:</h2>
...
<br>
<h2>Outcome:</h2>
Harlem Underworld successfully delivers an immersive strategy gaming experience that combines historical authenticity with engaging gameplay mechanics. The project demonstrates expertise in game development using modern web technologies, creating a complex simulation that balances multiple game systems while maintaining smooth performance and intuitive user experience. The game stands as a testament to creative storytelling merged with technical implementation in the gaming industry.`,o={title:"Harlem Underworld",date:"2025-06-23",permalink:"harlem-underworld",agency:"Freelance",type:"product",category:["Front-end","Game"],tag:["React","TypeScript","Vite","Tailwind CSS","Game Design","Strategy Game"],client:"Personal Project",tagline:"In Harlem, respect isn't given... it's taken.",case_link_url:"https://github.com/ehsanpo/harlem_underworld",onHome:!1,background_image:"1.png",logo:"2.png",images:["3.png","2.png"]},s="C:/Users/Ehsan/dev/astro-template/src/content/products/harlem-underworld/harlem-underworld.md",l=void 0;function v(){return`
<h2>Background:</h2>
Harlem Underworld is a top-down strategy game set in 1960s Harlem, inspired by the TV show "Godfather of Harlem" and the legendary Bumpy Johnson. This immersive gaming experience allows players to take control of the streets, build their criminal empire, and navigate the dangerous world of organized crime in one of New York's most iconic neighborhoods during the civil rights era.
...
`}function f(){return n}function b(){return[]}const w=t((c,m,h)=>{const{layout:g,...e}=o;return e.file=s,e.url=l,i`${a()}${r(n)}`});export{w as Content,f as compiledContent,w as default,s as file,o as frontmatter,b as getHeadings,v as rawContent,l as url};
