...
<p><img src="https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xu9gl7ulse1q3lu0p1e1.png" alt="Game Assets"></p>
<hr>
...
<p>Life = good ❤️🎧🚀</p>
<iframe width="100%" height="600" style="border-radius: 8px; margin: 2rem 0;" src="https://www.youtube.com/embed/laWv14Y59hg" title="WaveRider Gameplay" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,l={title:"WaveRider: Built in One Sunday",description:"A one-day build log of WaveRider from idea to deployment with AI-assisted tooling and Supabase backend. ",date:"2025-12-08",author:"Ehsan",category:["Development","Project Breakdown"],tag:["React Native","Expo","AI Development","Game Design","Supabase","Audio Analysis"],status:"publish",cover:"./cover2.jpg"},s="C:/Users/Ehsan/dev/astro-template/src/content/blog/waverider-sunday-build/index.md",r=void 0;function f(){return`
...
`}function w(){return n}function b(){return[]}const I=t((d,p,h)=>{const{layout:u,...e}=l;return e.file=s,e.url=r,i`${a()}${o(n)}`});export{I as Content,w as compiledContent,I as default,s as file,l as frontmatter,b as getHeadings,f as rawContent,r as url};
