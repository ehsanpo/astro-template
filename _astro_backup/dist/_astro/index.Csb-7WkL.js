const i="waverider-sunday-build/index.md",a="blog",o="waverider-sunday-build",l=`
...
`,s={title:"WaveRider: Built in One Sunday",description:"A one-day build log of WaveRider from idea to deployment with AI-assisted tooling and Supabase backend. ",date:"2025-12-08",author:"Ehsan",category:["Development","Project Breakdown"],tag:["React Native","Expo","AI Development","Game Design","Supabase","Audio Analysis"],cover:new Proxy({src:"/_astro/cover2.Dt76Iihj.jpg",width:1440,height:1080,format:"jpg",orientation:1,fsPath:"C:/Users/Ehsan/dev/astro-template/src/content/blog/waverider-sunday-build/cover2.jpg"},{get(n,e,t){return e==="clone"?structuredClone(n):e==="fsPath"?"C:/Users/Ehsan/dev/astro-template/src/content/blog/waverider-sunday-build/cover2.jpg":(n[e]!==void 0&&globalThis.astroAsset&&globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/blog/waverider-sunday-build/cover2.jpg"),n[e])}})},r={type:"content",filePath:"C:/Users/Ehsan/dev/astro-template/src/content/blog/waverider-sunday-build/index.md",rawData:void 0};export{r as _internal,l as body,a as collection,s as data,i as id,o as slug};
