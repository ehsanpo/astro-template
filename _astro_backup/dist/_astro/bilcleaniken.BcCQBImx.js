import{c as i,r as t,m as a}from"./instance.AS_mdBWu.js";import{u as o}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=`<h2>BilCleaniken Car Wash Website: A Case Study in Building an Effective Online Presence</h2>
  <h3>Introduction:</h3>
  <p>
...
<p>
  ...
  </p>`,s={title:"BilCleaniken",date:"2019",status:"publish",permalink:"bilcleaniken",author:"Ehsan",type:"portfolio",id:243,agency:"Freelance",category:["Backend","Design","Front-end"],tag:["Maintenance","Support","Wordpress","Web Development"],case_link_url:"http://bilcleaniken.se/",client:"BilCleaniken",tagline:"Biltvätt Malmö",background_image:"bilcleaniken-top.jpg",logo:"bilcleaniken-logo.png",video:"https://www.youtube.com/watch?v=UayOSFG0tUE",images:["bilcleaniken-1.png"]},r="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bilcleaniken/bilcleaniken.md",l=void 0;function f(){return`
...
`}function v(){return n}function w(){return[]}const b=i((c,h,p)=>{const{layout:d,...e}=s;return e.file=r,e.url=l,t`${a()}${o(n)}`});export{b as Content,v as compiledContent,b as default,r as file,s as frontmatter,w as getHeadings,f as rawContent,l as url};
