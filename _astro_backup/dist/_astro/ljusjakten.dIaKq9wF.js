import{c as a,r as t,m as i}from"./instance.AS_mdBWu.js";import{u as s}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=` <h2>Ljus Jakten: A Case Study in HTML5 Geo-Based Game Development for Öresundskraft</h2>
  <p>
  ...
  </p>`,o={title:"Ljusjakten",date:"2019-03-28T13:00:28+00:00",status:"publish",permalink:"ljusjakten",author:"Ehsan",type:"portfolio",id:338,agency:"Guts & Glory",category:["Backend","Mobile","UX"],tag:["HTML","HTML5 Geolocation","Javascript","Nodejs","React","Solution Architecture","UX","Webpack"],case_link_url:"https://ljusjakten.se/",body_text:[""],client:"Öresundskraft",tagline:"",background_image:"3.jpg",logo:"logo-1.png",video:"https://www.youtube.com/watch?v=bKgAt1hZeUg",images:["jj-1-Rotato-Snapshot.png","11.png","1.png"],port_date:["2018"],side_image:[""]},r="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/ljusjakten.md",c=void 0;function v(){return`
...
`}function k(){return n}function b(){return[]}const y=a((d,g,l)=>{const{layout:p,...e}=o;return e.file=r,e.url=c,t`${i()}${s(n)}`});export{y as Content,k as compiledContent,y as default,r as file,o as frontmatter,b as getHeadings,v as rawContent,c as url};
