import{c as a,r as i,m as n}from"./instance.AS_mdBWu.js";import{u as l}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const t=` <h3>Introduction:</h3>
  <p>
  ...
  </p>`,o={onHome:!0,title:"Malmö Saluhall",description:"Malmö Saluhall's award-winning website in collaboration with Guts & Glory, translating its new brand identity into a captivating digital presence.",date:"2017",status:"publish",permalink:"malmo-saluhall",author:"Ehsan",type:"portfolio",id:211,agency:"Guts & Glory",category:["Backend","Design","Front-end"],tag:["CSS","HTML","Maintenance","PHP","Support","Web Development","Wordpress"],case_link_url:"http://www.malmosaluhall.se",client:"Malmö Saluhall",tagline:"Ett himmelrike för matälskare",background_image:"malmo-saluhall-bg.jpg",logo:"malmo-saluhall-top.png",cover:"wsi-imageoptim-5_Malmo_saluhall_2104x1315-2048x1280.jpg",images:["malmosaluhall1.jpg"],port_date:["2017"]},s="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/malmo-saluhall/malmo-saluhall.md",r=void 0;function w(){return`
 <h3>Introduction:</h3>
  <p>
    With a new brand identity, Malmö Saluhall needed to update the digital profile of the website. As a developer at Gutsglory agency, I worked closely with Martin Johansson, the agency's art director, to build the website. The team collaborated to translate the new brand identity into a captivating digital UI. After completing the project, we provided support and maintenance for the site and implemented additional features. The successful outcome of the project was recognized when Malmö Saluhall was awarded Svenska Designpriset in the category of Digital Design.
  </p>
...
`}function b(){return t}function v(){return[]}const y=a((h,d,c)=>{const{layout:p,...e}=o;return e.file=s,e.url=r,i`${n()}${l(t)}`});export{y as Content,b as compiledContent,y as default,s as file,o as frontmatter,v as getHeadings,w as rawContent,r as url};
