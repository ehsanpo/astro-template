import{c as n,r as o,m as i}from"./instance.AS_mdBWu.js";import{u as a}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const t=` <h2>Guts &#x26; Glory Agency Website: A Case Study in WordPress Development</h2>
  <h3>Introduction:</h3>
  <p>
...
<h3>Portfolio and Clients:</h3>
  ...
  </p>`,s={title:"Guts & Glory",date:"2019",status:"publish",permalink:"guts-glory",author:"Ehsan",type:"portfolio",id:375,agency:"Guts & Glory",category:["Backend","Design","Front-end","Sysadmin"],tag:["CSS","HTML","Javascript","Redis","Web Development","Wordpress"],case_link_url:"https://gutsglory.se/",client:"Guts & Glory",tagline:"Allt inom reklam, kommunikation och design",background_image:"gg-bg.png",logo:"gg-logo.png",video:"",images:["gg-1.jpg"],port_date:["2019"]},r="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/guts-glory/guts-glory.md",l=void 0;function m(){return`
...
`}function w(){return t}function b(){return[]}const v=n((d,c,p)=>{const{layout:h,...e}=s;return e.file=r,e.url=l,o`${i()}${a(t)}`});export{v as Content,w as compiledContent,v as default,r as file,s as frontmatter,b as getHeadings,m as rawContent,l as url};
