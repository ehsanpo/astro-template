const e="building-animator-sprite-animation-tool/index.md",n="blog",t="building-animator-sprite-animation-tool",a=`
...
`,i={title:"From Skeptic to Believer: Building Animator with Wails (and why I was SO wrong about it!)",description:"I thought Wails was just another Electron wannabe... turns out it's actually FASTER than running in a browser! Here's how I built a sprite animation tool in just 1.5 days.",date:"2025-12-25",author:"Ehsan Pourhadi",category:["Game Development","Desktop Apps"],tag:["Wails","React","Go","Sprite Animation","CSS","TypeScript"],featured:!1,draft:!1},o={type:"content",filePath:"C:/Users/Ehsan/dev/astro-template/src/content/blog/building-animator-sprite-animation-tool/index.md",rawData:void 0};export{o as _internal,a as body,n as collection,i as data,e as id,t as slug};
