import{c as n,r as t,m as s}from"./instance.AS_mdBWu.js";import{u as o}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const i=`<h2>NOAAB: A Simple WordPress Website for Precision Machining</h2>
<h3>Introduction:</h3>
<p>
...
`}function y(){return i}function w(){return[]}const A=n((c,d,m)=>{const{layout:p,...e}=a;return e.file=r,e.url=l,t`${s()}${o(i)}`});export{A as Content,y as compiledContent,A as default,r as file,a as frontmatter,w as getHeadings,b as rawContent,l as url};
