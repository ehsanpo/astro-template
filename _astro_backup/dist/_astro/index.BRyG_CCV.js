const e="building-audio-tools-three-apps-one-passion/index.md",t="blog",n="building-audio-tools-three-apps-one-passion",o=`
...
Peace! ✨🎧
`,a={title:"Building Audio Tools: Three Apps, One Passion",description:"OMG so I went totally overboard and built THREE audio visualization tools! From trippy shaders to professional goniometers to 3D cymatics - here's my wild journey into making sound visible.",date:"2025-12-25",author:"Ehsan Pourhadi",category:["Web Development","Creative Coding","Audio"],tag:["Three.js","React","WebGL","Audio Visualization","TypeScript","Web Audio API"],featured:!0,draft:!1},i={type:"content",filePath:"C:/Users/Ehsan/dev/astro-template/src/content/blog/building-audio-tools-three-apps-one-passion/index.md",rawData:void 0};export{i as _internal,o as body,t as collection,a as data,e as id,n as slug};
