import{c as t,r as o,m as i}from"./instance.AS_mdBWu.js";import{u as n}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const a=`<h2>Nordiska Museet Swedish Apples App: A Case Study in Building a Comprehensive App for Swedish Apple Enthusiasts</h2>
  <h3>Introduction:</h3>
  <p>
  ...
  </p>`,s={title:"Äppleappen",date:"2019-03-28T10:31:34+00:00",status:"publish",permalink:"appleappen",author:"Ehsan",type:"portfolio",id:225,agency:"Whitespace",category:["Backend","Front-end","Mobile","UX"],tag:["Angular","CSS","HTML","Phonegap"],case_link_url:"http://api.appelappen.nordiskamuseet.se",client:"Nordiska museet",tagline:"Upptäck svenska äpplen i mobilen",background_image:"appleappen-top.jpg",logo:"appleappen-logo.jpg",video:"",images:["appleappen-1.jpg"],port_date:["2016"]},r="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/appleappen/appleappen.md",p=void 0;function g(){return`
...
`}function w(){return a}function y(){return[]}const b=t((l,d,h)=>{const{layout:u,...e}=s;return e.file=r,e.url=p,o`${i()}${n(a)}`});export{b as Content,w as compiledContent,b as default,r as file,s as frontmatter,y as getHeadings,g as rawContent,p as url};
