import{c as t,r as o,m as i}from"./instance.AS_mdBWu.js";import{u as s}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=`<h2>Slack Points Bot: Gamifying Team Collaboration</h2>
<h3>Overview:</h3>
<p>
...
</p>`,r={onHome:!1,title:"Slack Points Bot",title2:"Serverless Bot",description:"A serverless Slack bot built with Vercel Functions and Upstash Redis for managing and distributing points to team members with gamification features.",date:"2023-07-18",status:"publish",permalink:"slack-points-bot",author:"Ehsan",type:"product",id:2023001,category:["Backend"],tag:["Node.js","Vercel","Redis","Slack API","Serverless Functions"],background_image:"slackbot.png",logo:"slackbot.png",images:["slackbot.png"],tagline:"Gamify your team collaboration with points and rewards in Slack.",case_link_url:"",client:"Internal Project",agency:"Personal Development"},a="C:/Users/Ehsan/dev/astro-template/src/content/products/slack-points-bot/slack-points-bot.md",l=void 0;function b(){return`
...
`}function v(){return n}function w(){return[]}const k=t((c,d,m)=>{const{layout:p,...e}=r;return e.file=a,e.url=l,o`${i()}${s(n)}`});export{k as Content,v as compiledContent,k as default,a as file,r as frontmatter,w as getHeadings,b as rawContent,l as url};
