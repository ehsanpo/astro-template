import{c as i,r as t,m as a}from"./instance.AS_mdBWu.js";import{u as r}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=`<h2> Case Study: Driving Digital Transformation and Enhancing Customer Experience at Bredband2</h2>
<h3>Introduction: </h3>
...
</p><p>Furthermore, by actively pursuing continuous learning and acquiring certifications, I ensured that I remained at the forefront of industry trends and best practices, enabling me to contribute effectively to Bredband2’s success.</p><p></p>`,s={onHome:!0,title:"Bredband2",title2:"Customer Portal",description:`Redesigned Bredband2's website for a fresh, WCAG-compliant visual identity and developed the "Mitt Bredband2" customer portal, enabling secure self-service and reducing customer support calls.`,date:"2023",status:"publish",permalink:"bredband2",author:"Ehsan",type:"portfolio",id:142,agency:"",category:["Backend","Front-end"],tag:["React","Ruby","Javascript","Gatsby","UX"],case_link_url:"https://www.bredband2.com/",client:"Bredband2",tagline:"A smooth and secure digital everyday life for everyone.",background_image:"bg.jpg",logo:"logo.png",cover:"bb2.jpg",video:null,images:["bredband2-v2.png","1.jpg"]},o="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/Bredband2.md",l=void 0;function f(){return`
...
`}function y(){return n}function v(){return[]}const w=i((d,c,u)=>{const{layout:p,...e}=s;return e.file=o,e.url=l,t`${a()}${r(n)}`});export{w as Content,y as compiledContent,w as default,o as file,s as frontmatter,v as getHeadings,f as rawContent,l as url};
