import{c as n,r as a,m as i}from"./instance.AS_mdBWu.js";import{u as o}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const t=` <h2>Dos Gardenias Podcast Magazine Website: A Case Study in WordPress Development and SEO Optimization</h2>
  <h3>Introduction:</h3>
  <p>
  ...
  </p>`,r={title:"Dos Gardenias",date:"2019",status:"publish",permalink:"dosgardenias",author:"Ehsan",type:"portfolio",id:362,agency:"Guts & Glory",category:["Backend","Front-end"],tag:["CSS","HTML","PHP","Web Development"],case_link_url:"http://dosgardenias.se",client:"Dos Gardenias",tagline:"The addictive pod of the necessities of life.",background_image:"dosgardenias-bg.jpg",logo:"dosgardenias-logo.png",video:"",images:["dosgardenias-1.png"]},s="C:/Users/Ehsan/dev/astro-template/src/content/portfolio/dosgardenias/dosgardenias.md",d=void 0;function b(){return`
...
`}function w(){return t}function v(){return[]}const y=n((h,l,c)=>{const{layout:g,...e}=r;return e.file=s,e.url=d,a`${i()}${o(t)}`});export{y as Content,w as compiledContent,y as default,s as file,r as frontmatter,v as getHeadings,b as rawContent,d as url};
