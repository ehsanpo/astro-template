import{c as t,r as a,m as i}from"./instance.AS_mdBWu.js";import{u as s}from"./data.tPHRorFE.js";import"./astro/assets-service.DrwRx0W4.js";import"./clsx.B-dksMZM.js";const n=`<h2>Whitespace: Comprehensive Development and System Management</h2>
<h3>Introduction:</h3>
<p>
...
`}function v(){return n}function g(){return[]}const w=t((c,d,p)=>{const{layout:m,...e}=o;return e.file=r,e.url=l,a`${i()}${s(n)}`});export{w as Content,v as compiledContent,w as default,r as file,o as frontmatter,g as getHeadings,y as rawContent,l as url};
