...
const $$MusicProductionTechnologist = createComponent(async ($$result, $$props, $$slots) => {
...
</p> </div> </div> </div> </div> </section>  <section class="py-12"> <div class="container mx-auto"> ${renderComponent($$result2, "Heading", Heading, { "level": "h2", "gradient": true, "floating": true, "backplate": true, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "C:/Users/Ehsan/dev/astro-template/src/components/ui/heading", "client:component-export": "Heading" }, { "default": ($$result3) => renderTemplate`Creative & Technical Stacks` })} <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3"> ${musicStacks.map((stack, index) => renderTemplate`${renderComponent($$result2, "StackCard", StackCard, { ...stack, "parentIndex": index, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Ehsan/dev/astro-template/src/components/StackCard", "client:component-export": "default" })}`)} </div> </div> </section>  <section class="py-12"> <div class="container mx-auto"> ${renderComponent($$result2, "Heading", Heading, { "level": "h2", "gradient": true, "floating": true, "backplate": true, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "C:/Users/Ehsan/dev/astro-template/src/components/ui/heading", "client:component-export": "Heading" }, { "default": ($$result3) => renderTemplate`Music Production Skills` })} ${renderComponent($$result2, "SkillChart", SkillChart, { "data": [musicChart], "chartData": musicChart, "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Ehsan/dev/astro-template/src/components/SkillChart", "client:component-export": "default" })} </div> </section>  <section class="container mx-auto py-20"> ${renderComponent($$result2, "Heading", Heading, { "level": "h2", "gradient": true, "floating": true, "backplate": true, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "C:/Users/Ehsan/dev/astro-template/src/components/ui/heading", "client:component-export": "Heading" }, { "default": ($$result3) => renderTemplate`Music Production Tools` })} <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4"> ${musicTools.map((tool) => renderTemplate`<div class="rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-800"> <div class="mb-4 flex items-center"> <img${addAttribute(tool.icon, "src")}${addAttribute(tool.name, "alt")} class="mr-3 h-8 w-8"> <h3 class="text-lg font-semibold text-gray-900 dark:text-white">${tool.name}</h3> </div> <p class="mb-4 text-gray-600 dark:text-gray-400">${tool.description}</p> <div class="flex items-center"> <div class="flex-1"> <div class="h-2 w-full rounded-full bg-gray-200 dark:bg-neutral-700"> <div class="h-2 rounded-full bg-primary-600"${addAttribute(`width: ${tool.proficiency * 10}%`, "style")}></div> </div> </div> </div> </div>`)} </div> </section>  <section class="py-12"> <div class="container mx-auto px-4"> ${renderComponent($$result2, "Heading", Heading, { "level": "h2", "gradient": true, "floating": true, "backplate": true, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "C:/Users/Ehsan/dev/astro-template/src/components/ui/heading", "client:component-export": "Heading" }, { "default": ($$result3) => renderTemplate`Music Production Process` })} <div class="mx-auto max-w-4xl"> <div class="grid gap-8 md:grid-cols-3"> <div class="rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-800"> <div class="mb-4 text-4xl">🎵</div> <h3 class="mb-2 text-xl font-semibold text-primary-600 dark:text-primary-400">
...
</p> </div> <div class="rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-800"> <div class="mb-4 text-4xl">🎛️</div> <h3 class="mb-2 text-xl font-semibold text-primary-600 dark:text-primary-400">
2. Production & Mixing
</h3> <p class="text-gray-700 dark:text-gray-300">
Layer instruments, design custom sounds, apply effects, and balance levels for
							professional sound quality
</p> </div> <div class="rounded-lg bg-white p-6 shadow-lg dark:bg-neutral-800"> <div class="mb-4 text-4xl">🎧</div> <h3 class="mb-2 text-xl font-semibold text-primary-600 dark:text-primary-400">
3. Mastering & Release
</h3> <p class="text-gray-700 dark:text-gray-300">
Final polish with mastering techniques, prepare for distribution across platforms like
							SoundCloud and Spotify
</p> </div> </div> </div> </div> </section>  <section class="container mx-auto px-4 py-12"> ${renderComponent($$result2, "Heading", Heading, { "level": "h2", "gradient": true, "floating": true, "backplate": true, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "C:/Users/Ehsan/dev/astro-template/src/components/ui/heading", "client:component-export": "Heading" }, { "default": ($$result3) => renderTemplate`Featured Music` })} <div class="mx-auto max-w-4xl"> <div class="rounded-lg bg-white p-8 shadow-lg dark:bg-neutral-800"> <h3 class="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">
...
</p> <a href="https://soundcloud.com/eprumental" target="_blank" rel="noopener noreferrer" class="inline-flex items-center rounded-lg bg-primary-600 px-6 py-3 text-white transition-colors hover:bg-primary-700">
Visit SoundCloud
...
}, "C:/Users/Ehsan/dev/astro-template/src/pages/roles/music-production-technologist.astro", void 0);

const $$file = "C:/Users/Ehsan/dev/astro-template/src/pages/roles/music-production-technologist.astro";
