const id = "ljusjakten/ljusjakten.md";
						const collection = "portfolio";
						const slug = "ljusjakten/ljusjakten";
						...
						const data = {title:"Ljusjakten",tagline:"",date:"2019-03-28T13:00:28+00:00",permalink:"ljusjakten",client:"Öresundskraft",agency:"Guts & Glory",category:["Backend","Mobile","UX"],tag:["HTML","HTML5 Geolocation","Javascript","Nodejs","React","Solution Architecture","UX","Webpack"],case_link_url:"https://ljusjakten.se/",background_image:
						new Proxy({"src":"/_astro/3.DcL1imxX.jpg","width":1200,"height":630,"format":"jpg","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/3.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/3.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/3.jpg");
							return target[name];
						}
					})
					,logo:
						new Proxy({"src":"/_astro/logo-1.DsRmYk6r.png","width":3840,"height":2354,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/logo-1.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/logo-1.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/logo-1.png");
							return target[name];
						}
					})
					,images:[
						new Proxy({"src":"/_astro/jj-1-Rotato-Snapshot.DweaM9ii.png","width":3840,"height":2160,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/jj-1-Rotato-Snapshot.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/jj-1-Rotato-Snapshot.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/jj-1-Rotato-Snapshot.png");
							return target[name];
						}
					})
					,
						new Proxy({"src":"/_astro/11.B0gcl-11.png","width":4526,"height":2542,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/11.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/11.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/11.png");
							return target[name];
						}
					})
					,
						new Proxy({"src":"/_astro/1.DoXiQKvI.png","width":4530,"height":2544,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/1.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/1.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/1.png");
							return target[name];
						}
					})
					],type:"portfolio"};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/ljusjakten/ljusjakten.md",
							rawData: undefined,
						};
