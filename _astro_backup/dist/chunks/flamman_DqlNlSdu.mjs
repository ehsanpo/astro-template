const id = "flamman/flamman.md";
						const collection = "portfolio";
						const slug = "flamman/flamman";
						...
						const data = {title:"Flamman",tagline:"Socialt Förebyggande Centrum",date:"2019-03-28T14:20:11+00:00",permalink:"flamman",client:"Flamman SFC",agency:"Freelance",category:["Backend","Design","Front-end","Sysadmin","UX"],tag:["Web Development","Wordpress","Support"],case_link_url:"http://flammanmalmo.se/",background_image:
						new Proxy({"src":"/_astro/flamman-top.Cd5F3Sdo.jpg","width":960,"height":639,"format":"jpg","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-top.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-top.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-top.jpg");
							return target[name];
						}
					})
					,logo:
						new Proxy({"src":"/_astro/flamman-logo.3gQvQHIj.png","width":1980,"height":1394,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-logo.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-logo.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-logo.png");
							return target[name];
						}
					})
					,images:[
						new Proxy({"src":"/_astro/flamman-1.hdq7p4hu.jpg","width":1387,"height":6203,"format":"jpg","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-1.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-1.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman-1.jpg");
							return target[name];
						}
					})
					],onHome:false,type:"portfolio"};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/flamman/flamman.md",
							rawData: undefined,
						};
