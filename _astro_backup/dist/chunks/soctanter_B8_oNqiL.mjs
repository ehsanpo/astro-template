const id = "soctanter/soctanter.md";
						const collection = "portfolio";
						const slug = "soctanter/soctanter";
						...
						const data = {title:"Soctanter",tagline:"Malmö stads socialrådgivning på nätet vägleder dig i dina bekymmer.",date:"2019-03-28T12:03:32+00:00",permalink:"soctanter",client:"Malmöstad",agency:"Whitespace",category:["Backend","Front-end","UX"],tag:["Drupal","PHP","Support","UX","Web Development"],case_link_url:"https://soctanter.malmo.se",background_image:
						new Proxy({"src":"/_astro/bg.D9HMKKBJ.png","width":1436,"height":899,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/bg.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/bg.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/bg.png");
							return target[name];
						}
					})
					,logo:
						new Proxy({"src":"/_astro/logo.CjbPXcFi.png","width":500,"height":238,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/logo.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/logo.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/logo.png");
							return target[name];
						}
					})
					,images:[
						new Proxy({"src":"/_astro/1.D-sxztT4.png","width":1596,"height":1393,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/1.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/1.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/1.png");
							return target[name];
						}
					})
					,
						new Proxy({"src":"/_astro/2.DSfSk1oH.png","width":1596,"height":3421,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/2.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/2.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/2.png");
							return target[name];
						}
					})
					],type:"portfolio"};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/soctanter/soctanter.md",
							rawData: undefined,
						};
