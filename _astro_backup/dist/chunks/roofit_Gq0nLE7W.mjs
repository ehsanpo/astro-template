const id = "roofit/roofit.md";
						const collection = "portfolio";
						const slug = "roofit/roofit";
						...
						const data = {title:"RooFit",tagline:"En plåtslagare ska knacka plåt",date:"2019-03-28T12:54:27+00:00",permalink:"roofit",client:"Lindab",agency:"Guts & Glory",category:["Backend","Front-end"],tag:["Wordpress","HTML","Javascript","PHP"],case_link_url:"https://roofit.se/",background_image:
						new Proxy({"src":"/_astro/roofit-garanti-image.CFnu4krR.jpg","width":2179,"height":812,"format":"jpg","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/roofit-garanti-image.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/roofit-garanti-image.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/roofit-garanti-image.jpg");
							return target[name];
						}
					})
					,logo:
						new Proxy({"src":"/_astro/logo.DbU2U-Oe.png","width":1400,"height":900,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/logo.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/logo.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/logo.png");
							return target[name];
						}
					})
					,images:[
						new Proxy({"src":"/_astro/12.D8EheVhh.jpg","width":1080,"height":1080,"format":"jpg","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/12.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/12.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/12.jpg");
							return target[name];
						}
					})
					,
						new Proxy({"src":"/_astro/3.kpjMlGVt.jpg","width":1890,"height":4212,"format":"jpg","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/3.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/3.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/3.jpg");
							return target[name];
						}
					})
					],type:"portfolio"};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/roofit/roofit.md",
							rawData: undefined,
						};
