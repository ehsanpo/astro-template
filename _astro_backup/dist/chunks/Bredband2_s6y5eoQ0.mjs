const id = "bredband2/Bredband2.md";
						const collection = "portfolio";
						const slug = "bredband2/bredband2";
						...
						const data = {title:"Bredband2",title2:"Customer Portal",description:"Redesigned Bredband2's website for a fresh, WCAG-compliant visual identity and developed the \"Mitt Bredband2\" customer portal, enabling secure self-service and reducing customer support calls.",tagline:"A smooth and secure digital everyday life for everyone.",date:"2023",permalink:"bredband2",client:"Bredband2",agency:"",category:["Backend","Front-end"],tag:["React","Ruby","Javascript","Gatsby","UX"],case_link_url:"https://www.bredband2.com/",background_image:
						new Proxy({"src":"/_astro/bg.DEU1GqTm.jpg","width":1200,"height":630,"format":"jpg","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bg.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bg.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bg.jpg");
							return target[name];
						}
					})
					,cover:
						new Proxy({"src":"/_astro/bb2.DuN4vFpC.jpg","width":1500,"height":678,"format":"jpg","orientation":1,"fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bb2.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bb2.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bb2.jpg");
							return target[name];
						}
					})
					,logo:
						new Proxy({"src":"/_astro/logo.B9rufUi6.png","width":527,"height":417,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/logo.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/logo.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/logo.png");
							return target[name];
						}
					})
					,images:[
						new Proxy({"src":"/_astro/bredband2-v2.DlMeXiCJ.png","width":1517,"height":4984,"format":"png","fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bredband2-v2.png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bredband2-v2.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/bredband2-v2.png");
							return target[name];
						}
					})
					,
						new Proxy({"src":"/_astro/1.CccNSHSU.jpg","width":1368,"height":4582,"format":"jpg","orientation":1,"fsPath":"C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/1.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/1.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/1.jpg");
							return target[name];
						}
					})
						...
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Ehsan/dev/astro-template/src/content/portfolio/bredband2/Bredband2.md",
							rawData: undefined,
						};
