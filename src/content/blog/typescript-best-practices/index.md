...
| -------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `foo = { hello: 0}; ✅` <br/> `foo = []; ✅` <br/> `foo = false;❌` <br/> `foo = null;❌` <br/> `foo = undefined; ❌` <br/> `foo = 42;❌` <br/> `foo = 'bar';❌` | `foo = { hello: 0}; ✅` <br/> `foo = [];✅` <br/> `foo = false;✅` <br/> `foo = null;❌` <br/> `foo = undefined;❌` <br/> `foo = 42; ✅` <br/> `foo = 'bar'✅` |
|                                                                                                                                              |                                                                                                                                    |
