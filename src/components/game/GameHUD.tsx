	...
	return (
		<>
			...
			<div className="wires fixed left-0 right-0 top-[80px] z-40 m-auto flex w-80 justify-between">
				<svg
					className="relative top-[-33px] w-20 fill-primary-900"
				...
				<svg
					className="relative top-[-62px] w-16 rotate-180 fill-primary-900"
					xmlns="http://www.w3.org/2000/svg"
					version="1.1"
					viewBox="-5.0 -10.0 110.0 135.0"
				>
			...
			>
				<div className="clip pointer-events-auto relative flex items-center gap-3 rounded-sm bg-white/90 px-5 py-3 text-sm shadow-lg backdrop-blur dark:bg-neutral-900/80">
					<BlinkingLED className="absolute -top-1 left-2 -translate-y-1/2" color="#ef446a" />
					<BlinkingLED className="absolute -top-1 right-2 -translate-y-1/2" color="#ef446a" />
