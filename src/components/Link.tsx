...
const Button: React.FC<ButtonProps> = ({ href, text, className, target = "_self" }) => {
	return (
		<a
			...
			target={target}
		>
			<div className="bg-primary relative flex items-center justify-center overflow-hidden px-4 py-2">
				<div className="relative z-20">
					<div className="duration-[10.125s] ease-[cubic-bezier(0.19,1,0.22,1)] transform transition-transform group-hover:-translate-y-10">
						{text}
					</div>
			...
			<span className="bg-primary glitch-effect absolute inset-0 z-10 hidden group-hover:block"></span>
		</a>
	);
};
