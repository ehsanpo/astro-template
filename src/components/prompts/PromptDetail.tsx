...
export function PromptDetail({ prompt, children, className }: PromptDetailProps) {
	...
	return (
		<div className={cn("", className)}>
			...
			<div className="mb-6 flex justify-end">
				<button
					onClick={handleCopy}
					className="bg-primary hover:bg-primary/90 inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-medium text-white transition-colors"
				>
					{copied ? (
						<>
